<template>
  ...
  <div
    class="details"
    v-else-if="txnGroup == TransactionType.MOSAIC_SUPPLY_CHANGE"
  >
    <div>
  ...
  <div
    class="details"
    v-else-if="txnGroup == TransactionType.MODIFY_MOSAIC_LEVY"
  >
    <div>
    ...
    <div>
      ...
      <div>
        <router-link
          :to="{
            name: 'ViewAccount',
            params: { accountParam: txnDetail.detail.levyRecipient },
          }"
    ...
    <div v-if="txnDetail.detail.levyAssetName">
      ...
      <div>
        <router-link
          :to="{
            name: 'ViewAsset',
            params: { id: txnDetail.detail.levyAssetName },
          }"
