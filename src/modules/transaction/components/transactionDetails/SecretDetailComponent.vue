  ...
  <div class="details">
    <div>
      ...
      <div class="flex">
        <router-link :to="{ name: 'ViewAccount', params: { accountParam: txnDetail.detail.recipient } }"
          class="inline-block hover:text-blue-primary hover:underline text-blue-600" id="recipientAddress"
    ...
    <div v-if="txnDetail.detail.amount">
      ...
      <div>
        ...
        <div class="ml-1 inline-block font-bold" v-if="nativeTokenNamespace == txnDetail.detail.namespaceName">{{
          txnDetail.detail.namespaceName }}</div>
        <div v-else class="inline-block text-gray-400 text-txs hover:text-gray-700 duration-300 transition-all">
          <router-link :to="{ name: 'ViewAsset', params: { id: txnDetail.detail.assetId } }"
