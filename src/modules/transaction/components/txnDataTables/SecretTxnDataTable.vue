  ...
  <div>
    <DataTable
      ...
      <Column field="recipient" header="Recipient" headerStyle="width:110px;text-transform:uppercase" v-if="wideScreen">
        <template #body="{data}">
          <router-link :to="{ name: 'ViewAccount', params: { accountParam: data.recipient }}" class="hover:text-blue-primary text-blue-600 hover:underline truncate inline-block text-xs">
