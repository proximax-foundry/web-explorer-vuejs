  ...
  <div>
    ...
    >
      ...
      <Column style="width: 200px" v-if="!wideScreen">
        <template #body="{ data }">
          ...
          <div>
            ...
            <div class="flex items-center">
              <span
                class="inline-block bg-blue-100 text-blue-700 font-bold text-xs py-1 px-2 break-all"
              >
                {{ data.aliasName }}
                <font-awesome-icon
      ...
      >
        <template #body="{ data }">
          <span
            class="inline-block bg-blue-100 text-blue-700 font-bold text-xs py-1 px-2 my-1 mx-1 break-all"
          >
            {{ data.aliasName }}
            <font-awesome-icon
              v-if="data.aliasTypeName === 'Link'"
