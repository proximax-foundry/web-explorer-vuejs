<template>
  <div>
    <DataTable
      ...
      <Column field="timestamp" header="Timestamp" v-if="selectedGroupType === transactionGroupType.CONFIRMED && wideScreen" headerStyle="width:180px;text-transform:uppercase">
        <template #body="{data}">
