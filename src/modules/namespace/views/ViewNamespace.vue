<template>
  ...
  <div v-else>
    <div class="text-gray-500 mb-5 font-bold mx-5 md:mx-0">
    ...
    <div class="md:grid md:grid-cols-2 mx-5 md:mx-0">
    ...
    <div v-if="namespaceInfo.alias || namespaceInfo.levels" class="filter shadow-xl border border-gray-50 p-5 mb-15  mx-5 md:mx-0">
