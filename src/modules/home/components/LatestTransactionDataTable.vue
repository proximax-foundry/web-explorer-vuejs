<template>
  <div class="border divide-y divide-gray-200">
    <div class="font-bold text-base ml-4 mt-4 mb-4">Latest Transactions</div>
    <div v-if="isFetching">
    ...
    <div v-else>
      ...
      >
        <Column style="width: 20px" v-if="!wideScreen">
          <template #body="{ data }">
            <div class="mb-2 px-4">
              <div class="uppercase text-xs text-gray-300 font-bold mt-1 mb-2">
                TX HASH
              </div>
              <router-link
        ...
        <Column style="width: 240px" v-if="!wideScreen">
          <template #body="{ data }">
            <div class="-ml-1">
              <div class="uppercase text-xs text-gray-300 font-bold -mt-3 mb-2">
                Signer / TX Type
              </div>
              ...
              <router-link
                ...
                class="uppercase font-bold text-xs text-blue-600 ml-1 hover:text-blue-primary hover:underline inline-flex"
                ><span class="text-ellipsis overflow-hidden truncate w-36">{{
          ...
          <template #body="{ data }">
            <div>
              <div class="text-xs text-gray-500 inline-flex truncate pt-2">
                SIGNER:
                <div class="uppercase text-xs pl-1.5">
                  <router-link
                    :to="{
                      name: 'ViewAccount',
                      params: { accountParam: data.signerAddress },
