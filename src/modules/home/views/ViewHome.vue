    ...
    <div class="xl:grid xl:grid-cols-2 xl:mb-10 xl:gap-4 md:grid md:grid-cols-2 md:mb-5 md:gap-4 sm:mb-5 sm:grid-cols-1 sm:gap-4">
      ...
      <div>
        <div class="grid grid-cols-2"> 
          <div>
            <div class="text-xs text-gray-400 xl:ml-20 md:ml-20 sm:ml-2 mt-5">Latest Block</div>
            <div class="text-base font-bold xl:ml-20 md:ml-20  mb-5">{{trx==null?'Fetching...':trx.numBlocks}}</div>
          </div>
          
          <div>
            <div class="text-xs text-gray-400 xl:ml-6 md:ml-6 sm:ml-2 mt-5 ">Transactions</div>
            <div class="text-base font-bold xl:ml-7 md:ml-7 mb-5">{{trx==null?'Fetching...':trx.numTransactions}}</div>
          </div>    
        </div>
      </div>
    </div>
      ...
      <div class="box-border h-auto w-auto" style="width: 540px">  
        <LatestBlockDataTable></LatestBlockDataTable>
         <button class="content-center w-full h-6 text-xs text-center text-blue-primary rounded-none bg-gray-200" @click="showBlockList(trx.numBlocks)">View all blocks</button>
      </div>
      <div class="box-content h-auto w-auto border-collapse" style="width:540px">  
        ...
        <button class="content-center w-full h-6 text-xs text-center text-blue-primary rounded-none bg-gray-200" @click="showTransactionList">View all transactions</button>       
      </div>
      <br>
    </div>
  </div>
