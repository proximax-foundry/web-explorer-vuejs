...
export class NetworkStateUtils {
  ...
  static setAPINodeInit(): void {
    ...
    SessionService.setNumber(
      "nodePort",
      networkState.currentNetworkProfile?.httpPort || 3000
    );
    ...
    AppState.networkType = ChainUtils.getNetworkType(
  ...
  static buildAPIEndpointURL(url: string): string {
    const portNumber = networkState.currentNetworkProfile
